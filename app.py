...
if st.button('Predict Probability'):
    ...
    input_df = pd.DataFrame({'BattingTeam':[batting_team],'bowling_team':[bowling_team],'City':[selected_city],'runs_left':[runs_left],'balls_left':[balls_left],'wickets':[wickets],'total_run_x':[target],'crr':[crr],'rrr':[rrr]})
